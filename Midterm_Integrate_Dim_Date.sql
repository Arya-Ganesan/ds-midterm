...
# ==============================================================
ALTER TABLE movies_dw.fact_orders
...
# ==============================================================
UPDATE movies.fact_orders AS fo
JOIN movies.dim_date AS dd
ON DATE(fo.order_date) = dd.full_date
SET fo.order_date_key = dd.date_key;

UPDATE movies_dw.fact_orders AS fo
...
# =============================================================
SELECT * FROM movies_dw.fact_orders
LIMIT 10;
